class Validate {
    ...
    ValidatePassword(passwd) {
        ...
        if (checklower.test(passwd) == false || checkupper.test(passwd) == false || checknumber.test(passwd) == false ) {
            console.log("Password must conatin at least one Uppercase letter and a number");
            return (0);
        }
        return(1);
    };
